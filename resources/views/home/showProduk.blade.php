    ...
    <div class="product-detail">
        <div class="row">
            ...
            <div class="col-md-7 product-info">
                ...
                <form id="addToCartForm" action="{{ route('keranjang.add', $produk->id) }}" method="POST" class="mt-4">
                    @csrf
                    <div class="row align-items-center">
                        <div class="col-4">
                            <label for="qty" class="form-label fw-semibold">Jumlah</label>
                            <input type="number" name="qty" id="qty" class="form-control" min="1" max="{{ $produk->stok }}" value="1">
                        </div>
                    </div>

                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn-orange">Tambah ke Keranjang</button>
                        <a href="{{ route('login') }}" class="btn-outline-orange text-center">Beli Sekarang</a>
                    </div>
                </form>
